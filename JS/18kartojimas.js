...
document.querySelector('#h1-color-back').addEventListener('click', () => document.querySelector('h1').style.color = "darkgreen");
...
document.querySelector('#h1-font-back').addEventListener('click', () => document.querySelector('h1').style.fontSize = null);
...
document.querySelectorAll('li').forEach ((e, i) => document.querySelectorAll('li')[i].addEventListener('click', () => {
    if (!document.querySelectorAll('li')[i].classList.contains('like-button')){
        document.querySelectorAll('li').forEach (() => document.querySelectorAll('li')[i].style.fontSize = "130%")
}}));
...
DD.forEach ((e, i) => (DD[i].addEventListener('click', () =>{
    XX.forEach (() => (XX[i].classList.toggle('like')));
})));
...
document.querySelector('div.prices').appendChild(E);
...
const FF = document.createTextNode('NEPATINKA');
EE.appendChild(FF);

const DD1 = document.querySelectorAll('li.like-button');



const DD2 = document.querySelectorAll('.like-button');
// const XX = document.querySelectorAll('ul');
